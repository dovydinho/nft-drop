    ...
    <>
      <div className="relative lg:h-screen flex flex-col lg:flex-row">
        ...
        <motion.div
          ...
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.3 }}
          className="lg:h-screen w-full lg:w-1/2 xl:w-3/5 flex flex-col items-center justify-between px-2 sm:px-10"
        >
          <Navbar />
          <div className="text-center max-w-3xl">
            ...
            <p className="my-6 text-gray-500">{props.collection.description}</p>
